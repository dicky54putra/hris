            ...
            [
                ...
                'value' => function ($model) {
                    ...
                    if ($cek_absensi == 1) {
                        ...
                        return "<a href='index.php?r=absensi/masuk&id=" . $model->id_karyawan . "' class='btn  bg-blue btn-flat'>Masuk</a>  
                         <a href='index.php?r=absensi/izin&id=" . $model->id_karyawan . "' class='btn  bg-green btn-flat'>Izin</a>   
                         <a href='index.php?r=absensi/cuti&id=" . $model->id_karyawan . "' class='btn  bg-yellow btn-flat'>Cuti</a>   
                         <a href='index.php?r=absensi/alfa&id=" . $model->id_karyawan . "' class='btn  bg-red btn-flat'>Alfa</a>";
                    }
                }
            ],
